        ...
        <div className="space-y-2">
          ...
          <div className="relative group">
            ...
            <input
              ...
              type="email" autoCapitalize="none" autoCorrect="off" autoComplete="off" placeholder="parent@example.com" value={email}
        ...
        <div className="space-y-2">
          ...
          <div className="relative group">
            ...
            <input
              ...
              type={showPassword ? "text" : "password"} autoCapitalize="none" autoCorrect="off" autoComplete="new-password" placeholder="••••••••" value={password}
