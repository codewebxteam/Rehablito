                  ...
                  <div>
                    ...
                    {selectedPending.screenshot ? (
                      <div className="border border-outline-variant/20 rounded-xl overflow-hidden bg-surface-container hover:opacity-90 transition-opacity">
                        <a 
                          href={selectedPending.screenshot.startsWith('http') ? selectedPending.screenshot : `https://api.rehablito.com${selectedPending.screenshot}`} 
                          target="_blank" 
                        ...
                        >
                          <img 
                            src={selectedPending.screenshot.startsWith('http') ? selectedPending.screenshot : `https://api.rehablito.com${selectedPending.screenshot}`} 
                            alt="Payment Proof" 
