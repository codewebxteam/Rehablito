  ...
  const rightContent = (
    <div className="w-full max-w-sm mx-auto">
      <div className="mb-8 text-center sm:text-left">
        ...
        <h2 className="text-3xl font-bold text-on-background tracking-tight">Admin Sign In</h2>
        <p className="text-on-surface-variant mt-2 font-medium">Restricted to authorized administrators only.</p>
      </div>
